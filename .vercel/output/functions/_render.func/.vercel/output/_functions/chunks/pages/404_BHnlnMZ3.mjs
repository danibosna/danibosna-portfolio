/* empty css                          */
import { c as createComponent, r as renderTemplate, m as maybeRenderHead, d as addAttribute, e as renderComponent, f as createAstro, g as renderHead, h as renderSlot } from '../astro_CbfoSXOY.mjs';
/* empty css                              */
...
const Header = ({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "w-full grid grid-cols-[25%_1fr_25%]", children: [
    /* @__PURE__ */ jsx("h1", { className: "w-full text-center col-start-2 text-2xl font-semibold text-slate-400", children: sectionTitle }),
    /* @__PURE__ */ jsx("div", { className: "w-full col-start-3 text-center", children: buttonData?.showButton && /* @__PURE__ */ jsx(
      Button,
      {
        type: "button",
...
const alertIcon = new Proxy({"src":"/_astro/bitcoin.BIUHB56k.svg","width":64,"height":64,"format":"svg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/home/azazel/Dev/project-danibosna/danibosna-portfolio/src/assets/images/bitcoin.svg";
							}
...
export { $$ViewTransitions as $, Header as H, _404 as _, $$Modal as a, $$MainLayout as b, cn as c, getPageMetadata as g };
