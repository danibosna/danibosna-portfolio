...
import { buildSdkInitFileImportSnippet, buildClientSnippet, buildServerSnippet } from './snippets.js';

const PKG_NAME = '@sentry/astro';

const sentryAstro = (options = {}) => {
  return {
    name: PKG_NAME,
    hooks: {
...
function getSourcemapsAssetsGlob(config) {
